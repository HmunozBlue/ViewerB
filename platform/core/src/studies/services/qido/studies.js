...
function getQIDOQueryParams(filter, serverSupportsQIDOIncludeField) {
  ...
  const parameters = {
    ...
    patientBirthdate: filter.patientBirthdate,
    patientAge: filter.patientAge,
    patientSex: filter.patientSex,
...
function resultDataToStudies(resultData) {
  ...
  resultData.forEach(study =>
    studies.push({
      ...
      stationName: DICOMWeb.getString(study['00081010']),
      OperatorName: DICOMWeb.getString(study['00081070']),
      // 00081190 = URL
      ...
      patientAge: DICOMWeb.getNumber(study['00101010']),
