 ...
 * @param studyInstanceUid
 * @param resultData
 * @returns {{seriesList: Array, patientName: *, patientId: *, accessionNumber: *, stationName: *, operatorsName: *, studyDate: *, studyTime: *, modalities: *, studyDescription: *, imageCount: *, studyInstanceUid: *}}
 */
async function resultDataToStudyMetadata(server, studyInstanceUid, resultData) {
  ...
  const studyData = {
    ...
    studyTime: DICOMWeb.getString(anInstance['00080030']),
    modality: DICOMWeb.getString(anInstance['00080060']),
    ...
    resultData.map(async function(instance) {
      ...
      if (!series) {
        series = {
          ...
          stationName: DICOMWeb.getString(instance['00081010']),
          operatorsName: DICOMWeb.getName(instance['00081070']),
          instances: [],
        };
