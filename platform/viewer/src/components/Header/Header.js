...
class Header extends Component {
  ...
  //al comentar esta linea se quita el logo que no se ve, atras de la barrra de imagenes en la ventana de estudio.
  static defaultProps = {
    home: true,
    children: OHIFLogo(),
  };
      ...
      <div className={`entry-header ${this.props.home ? 'header-big' : ''}`}>
        <div className="header-left-box">
          ...
          {showStudyList && !this.props.home && (
            <Link
              className="header-btn header-studyListLinkSection" //CREO QUE ESTO ES EL DEL BOTON QUE SE OBSERVA ATRAS MODIFICAR DESPUES
              to={{
                pathname: '/',
