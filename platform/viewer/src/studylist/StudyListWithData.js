...
class StudyListWithData extends Component {
  ...
  static rowsPerPage = 20;
  static defaultSort = { field: 'patientName', order: 'asc' };

  static studyListDateFilterNumDays = 0; // Cambia la busqueda, aquí tiene 50 dias de busqueda
  ...
  searchForStudies = (searchData = StudyListWithData.defaultSearchData) => {
    ...
    const filter = {
      ...
      stationName: searchData.stationName,
